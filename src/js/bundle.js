...
/* harmony import */ var _modules_renderTable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/renderTable */ "./src/js/modules/renderTable.js");
/* harmony import */ var _modules_renderPreview__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/renderPreview */ "./src/js/modules/renderPreview.js");
/* harmony import */ var _modules_showLanguage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showLanguage */ "./src/js/modules/showLanguage.js");
...
document.addEventListener("DOMContentLoaded", function () {
  Object(_services_getData__WEBPACK_IMPORTED_MODULE_0__["default"])("../../assets/data.json").then(function (data) {
    Object(_modules_renderTable__WEBPACK_IMPORTED_MODULE_1__["default"])(data);
    Object(_modules_renderPreview__WEBPACK_IMPORTED_MODULE_2__["default"])(data);
    return data;
  }).then(function (data) {
...
/***/ "./src/js/modules/controlPanel/filterInput.js":
/*!****************************************************!*\
  !*** ./src/js/modules/controlPanel/filterInput.js ***!
  \****************************************************/
...
var filterInput = function filterInput(data) {
  ...
  var sortByInput = function sortByInput(arr, lang, target) {
    ...
    arr.map(function (item, i) {
      var UserName = item.name[lang];
      var UserNameReverse = item.name[lang].split(" ").reverse().join(" ");
      var regexp = new RegExp("".concat(value), "ig");
      var currentUser = document.querySelectorAll("[data-sort-id=\"".concat(i, "\"]"));
  ...
  sortingInput.addEventListener("input", function (e) {
    //определяем язык страницы
    (function () {
      var langBtns = document.querySelectorAll("[data-showlang]");
...
/***/ "./src/js/modules/controlPanel/sortSection.js":
/*!****************************************************!*\
  !*** ./src/js/modules/controlPanel/sortSection.js ***!
  \****************************************************/
/*! exports provided: sortingHandlers, sortByProp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortingHandlers", function() { return sortingHandlers; });
...
/* harmony import */ var _renderTable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../renderTable */ "./src/js/modules/renderTable.js");
/* harmony import */ var _renderPreview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../renderPreview */ "./src/js/modules/renderPreview.js");
/* harmony import */ var _showLanguage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../showLanguage */ "./src/js/modules/showLanguage.js");
...
var addActivClass = function addActivClass(allBtns, currentBtn, activClass) {
  allBtns.forEach(function (item) {
    item.classList.remove(activClass);
  });
  document.querySelector("#sort-".concat(currentBtn)).classList.add(activClass);
};

var sortByProp = function sortByProp(data, prop, type) {
  var currentLang = null; //получить текущий язык
  ...
  var sortById = function sortById(arr) {
    arr.sort(function (a, b) {
      return a.id - b.id;
    });
  };

  var sortByAge = function sortByAge(arr) {
    arr.sort(function (a, b) {
      return a.age - b.age;
    });
  };

  var sortByName = function sortByName(arr, lang) {
    arr.sort(function (first, second) {
      var firstUser = first.name[lang];
      var secondUser = second.name[lang];
  ...
  Object(_renderTable__WEBPACK_IMPORTED_MODULE_3__["default"])(data);
  Object(_renderPreview__WEBPACK_IMPORTED_MODULE_4__["default"])(data);
  Object(_showLanguage__WEBPACK_IMPORTED_MODULE_5__["changeLanguage"])(currentLang);
};

var sortingHandlers = function sortingHandlers(data) {
  var sortProp = "id";
  var sortType = "toLower";
  var sortPropertyBtns = document.querySelectorAll("[data-sort-value]");
  var sortTypeBtns = document.querySelectorAll("[data-sort-type]");
  var activClass = "is-checked";

  var checkProp = function checkProp(e) {
    var currentProp = e.target.getAttribute("data-sort-value") || e.target.parentNode.getAttribute("data-sort-value");
    var currentType = e.target.getAttribute("data-sort-type") || e.target.parentNode.getAttribute("data-sort-type"); //Перезаписали значение. Если нажали
  ...
  document.querySelector(".controlPanel__sort").addEventListener("click", function (e) {
    checkProp(e);
...
/***/ "./src/js/modules/controlPanel/viewSection.js":
/*!****************************************************!*\
  !*** ./src/js/modules/controlPanel/viewSection.js ***!
  \****************************************************/
/*! exports provided: default */
...
var viewHandlers = function viewHandlers() {
  var _toggleClass = function _toggleClass(selector, add, remove) {
  ...
  var btnsContainer = document.querySelector(".controlPanel__buttons_view");
  var viewBtns = btnsContainer.querySelectorAll("[data-view]");
  var activClass = "is-checked";
  btnsContainer.addEventListener("click", function (e) {
    viewBtns.forEach(function (elem) {
      if (e.target === elem || e.target.parentNode === elem) {
        viewBtns.forEach(function (item) {
          return item.classList.remove(activClass);
        });
...
/***/ "./src/js/modules/renderPreview.js":
/*!*****************************************!*\
  !*** ./src/js/modules/renderPreview.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _trasnsliteration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./trasnsliteration */ "./src/js/modules/trasnsliteration.js");
...
/* harmony default export */ __webpack_exports__["default"] = (renderPreview);
...
var renderTable = function renderTable(data) {
  var userList = document.querySelector("#table .users");
  userList.innerHTML = "";
  data.map(function (_ref) {
    var id = _ref.id,
        age = _ref.age,
...
/***/ "./src/js/modules/showLanguage.js":
/*!****************************************!*\
  !*** ./src/js/modules/showLanguage.js ***!
  \****************************************/
/*! exports provided: showLanguageHandler, changeLanguage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showLanguageHandler", function() { return showLanguageHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeLanguage", function() { return changeLanguage; });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _controlPanel_sortSection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controlPanel/sortSection */ "./src/js/modules/controlPanel/sortSection.js");
...
var _setDefaultSorting = function _setDefaultSorting(btnsSelector) {
...
var showLanguageHandler = function showLanguageHandler(data) {
  var showLang = null;
  changeLanguage();
  var btnLang = document.querySelector(".showLang__btn");
  btnLang.addEventListener("click", function (e) {
    ...
    Object(_controlPanel_sortSection__WEBPACK_IMPORTED_MODULE_2__["sortByProp"])(data, "id", "toLower");
  });
};
...
/***/ "./src/js/modules/trasnsliteration.js":
/*!********************************************!*\
  !*** ./src/js/modules/trasnsliteration.js ***!
  \********************************************/
/*! exports provided: default */
...
var transliterationRU = function transliterationRU(str) {
  var translit = {
    j: "Х",
    u: "y",
    n: "н",
...
/* harmony default export */ __webpack_exports__["default"] = (transliterationRU);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(url, ", status ").concat(res.text));
